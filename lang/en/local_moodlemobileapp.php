...
$string['core.errorinvalidresponse'] = 'Invalid response received for {{method}} webservice.';
...
$string['core.login.faqcannotfindmysiteanswer'] = 'If you still can\'t find it, please contact your school or learning provider for help.';
$string['core.login.faqcannotfindmysitequestion'] = 'I can\'t find my site by address.';
...
$string['core.login.faqwhatisurlanswer'] = '<p>If you can\'t find your site by name, try searching by address instead.</p><p>To find your site address:</p><ol><li>Open a web browser and go to your Moodle site login page.</li><li>At the top of the page, in the address bar, you will see the URL of your Moodle site e.g. "campus.example.edu".<br>{{$image}}</li><li>Copy the address (don\'t copy the /login nor what comes after), paste it into <strong>Your site</strong> in the app, then tap <strong>Connect to your site</strong></li><li>Now you can log in to your site with your username and password.</li></ol>';
...
$string['core.login.invalidmoodleversion'] = 'Invalid Moodle site version. The Moodle app only supports Moodle systems {{$a}} onwards.';
