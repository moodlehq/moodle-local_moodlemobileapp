...
$string['mm.course.activitynotyetviewableinapp'] = 'We are working on supporting the {{$a}} activity. Come back soon!';
$string['mm.course.activitynotyetviewableremoteaddon'] = 'This activity is a 3rd party addon not yet supported by the app. Come back soon!';
$string['mm.course.activitynotyetviewablesiteupgradeneeded'] = 'The site is not using the latest version of Moodle. Please contact the site administrator.';
