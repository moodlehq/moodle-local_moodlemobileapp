...
$string['addon.mod_assign.multiplemarkersnotsupported'] = 'Multiple markers are not yet supported by the app and cannot be modified.';
$string['addon.mod_assign.multiplemarkersnotsupportedfeedback'] = 'This assignment can have multiple markers. Any feedback from them is only available in the browser.';
...
$string['addon.mod_bigbluebuttonbn.moderatorhasjoinedlong'] = 'The moderator has joined. You can now join the session.';
$string['addon.mod_bigbluebuttonbn.moderatorhasjoinedshort'] = 'Moderator has joined.';
$string['addon.mod_bigbluebuttonbn.stillwaitingformoderator'] = 'Still waiting for the moderator to join.';
...
$string['addon.mod_forum.noactionsavailable'] = 'No actions available';
$string['addon.mod_forum.nopermissiontoact'] = 'You don\'t have permission to act on this post.';
$string['addon.mod_forum.numreplies'] = '{{numreplies}} replies';
$string['addon.mod_forum.offlinereconnectactions'] = 'You\'re offline. Reconnect to use these actions.';
$string['addon.mod_forum.postingroup'] = 'Posting in group "{{groupname}}".';
$string['addon.mod_forum.reconnecttomanage'] = 'Reconnect to manage this post.';
...
$string['core.contentlinks.confirmlinktosite'] = 'This link will take you to:<br><br><strong>{{url}}</strong><br><br>Only continue if you trust this site.';
$string['core.contentlinks.confirmlinktositetitle'] = 'Open another site?';
$string['core.contentlinks.confirmlinktothissitetitle'] = 'Open this site?';
$string['core.contentlinks.confirmqrsiteurltologin'] = 'This QR code will take you to:<br><br><strong>{{url}}</strong><br><br>Only continue if you trust this site.';
...
$string['core.contentlinks.opensite'] = 'Open site';
...
$string['core.h5p.unsupportedinteractivevideomessage'] = 'This is an interactive video that needs a browser to work. Open it to use all its features.';
$string['core.h5p.unsupportedinteractivevideotitle'] = 'This interactive video opens in a browser';
...
$string['core.login.mobileaccessnotenabled'] = 'Site not enabled for mobile app access';
...
$string['core.openinbrowserdescription'] = 'You will be taken to a web page';
...
$string['core.reminders.noreminders'] = 'No reminders scheduled';
$string['core.reminders.reminderset'] = 'Reminder set for {{$a}}';
$string['core.reminders.reminderunset'] = 'Reminder deleted';
$string['core.reminders.scheduledreminders'] = 'Scheduled reminders';
...
$string['core.settings.fontsizecharacter'] = 'A';
...
$string['core.user.limitedprofile'] = 'This profile is limited';
$string['core.user.privateprofiledetails'] = 'This user\'s profile details are kept private based on your role or site settings.';
...
$string['freemium.confirmqrautologintosite'] = 'This QR code will log you in to:<br><br><strong>{{url}}</strong><br><br>Only continue if you trust this site.';
$string['freemium.confirmqrautologintositetitle'] = 'Log in to this site?';
...
$string['freemium.qrlogindisabled'] = 'Authentication in the app using a QR code is not available for the site.';
...
$string['freemium.subscription_currentplan'] = 'Your current plan';
$string['freemium.subscription_limitedfeatures'] = 'Limited features';
...
$string['freemium.subscriptionplan_deprecated_message'] = 'We\'re no longer offering Pro to new customers, but your subscription is unaffected.';
$string['freemium.subscriptionplan_deprecated_title'] = 'Your Pro plan stays the same';
$string['freemium.subscriptionplan_expired'] = 'Expired';
$string['freemium.subscriptionplan_expireson'] = 'Expires on {{date}}';
$string['freemium.subscriptionplan_free'] = 'Free';
$string['freemium.subscriptionplan_manage'] = 'Manage subscription';
$string['freemium.subscriptionplan_overlimits_message'] = 'You have reached the limits of your {{plan}} plan. Upgrade to Premium to remove these limits and keep all features active.';
$string['freemium.subscriptionplan_overlimits_title'] = 'You\'re over your {{plan}} plan limits';
$string['freemium.subscriptionplan_upgrade'] = 'Upgrade to Premium';
$string['freemium.subscriptionplanlearnmore'] = 'Learn more';
$string['freemium.upsell_batchdownloads_message'] = 'Save time by downloading multiple courses at once.';
$string['freemium.upsell_batchdownloads_title'] = 'Upgrade for batch downloads';
$string['freemium.upsell_coursedownload_managers_message'] = '{{plan}} plans allow {{limit}} courses per device. Unlock unlimited downloads.';
$string['freemium.upsell_coursedownload_managers_title'] = 'Course download limit reached';
$string['freemium.upsell_coursedownload_message'] = 'Your {{plan}} plan allows up to {{limit}} downloads per device.';
$string['freemium.upsell_coursedownload_message_additional'] = 'Upgrade to give all users unlimited downloads for offline access.';
$string['freemium.upsell_coursedownload_message_help'] = 'Need more? Ask your admin for Premium features.';
$string['freemium.upsell_coursedownload_title'] = 'Download limit reached';
$string['freemium.upsell_custommenuitem_info'] = 'The number of custom items allowed in your plan is {{limit}}. Other users can\'t see additional custom items.';
$string['freemium.upsell_custommenuitem_message'] = 'Upgrade to Premium to add as many custom links as you need.';
$string['freemium.upsell_custommenuitem_title'] = 'Custom menu item limit reached';
$string['freemium.upsell_fingerprintlogin_message'] = 'Upgrade to Premium to help everyone log in faster while keeping your site secure.';
$string['freemium.upsell_fingerprintlogin_title'] = 'Enable fingerprint login';
$string['freemium.upsell_premiumplanrequired'] = 'Premium plan required';
