...
$string['addon.block_myoverview.favouritesonly'] = 'Show starred courses only';
...
$string['addon.mod_quiz.reviewofattempt'] = 'Review of attempt {{$a}}';
$string['addon.mod_quiz.reviewofpreview'] = 'Review of preview';
...
$string['core.ajaxendpointnotfound'] = '<p>AJAX endpoint not found. This can happen if the Moodle site is too old or it blocks access to this endpoint. The Moodle app only supports Moodle systems {{$a}} onwards. Please contact your site administrator.</p>
<p>{{whoisadmin}}</p>';
...
$string['core.certificaterror'] = '<p>The certificate of this site cannot be trusted by your device. Please contact your site administrator.</p>
<p>{{whoisadmin}}</p>';
...
$string['core.course.gotonextactivity'] = 'Go to next activity';
$string['core.course.gotonextactivitynotfound'] = 'Next activity not found. It\'s possible that it has been hidden or deleted.';
$string['core.course.gotopreviousactivity'] = 'Go to previous activity';
$string['core.course.gotopreviousactivitynotfound'] = 'Previous activity not found. It\'s possible that it has been hidden or deleted.';
...
$string['core.settings.accessibilitystatement'] = 'Accessibility statement';
...
$string['core.settings.forcesafeareamargins'] = 'Force safe area margins';
...
$string['core.settings.pluginstyles'] = 'Enable site plugin styles';
...
$string['core.settings.remotestyles'] = 'Enable remote styles';
...
$string['core.settings.siteplugins'] = 'Site plugins';
...
$string['core.settings.textdirection'] = 'Text direction';
