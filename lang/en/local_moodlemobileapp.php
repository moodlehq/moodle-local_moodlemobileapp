...
$string['freemium.upsell_coursedownload_message'] = 'Your {{ plan }} plan allows up to {{ limit }} downloads per device. Upgrade to give all users unlimited downloads for offline access.';
