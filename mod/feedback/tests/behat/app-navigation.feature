...
Feature: Test feedback navigation
  ...
  Background:
    ...
    And the following "mod_feedback > items" exist:
      | feedback | position | name              |
      | feedback | 1        | Feedback question |
    And the following "mod_feedback > attempts" exist:
      | feedback | answers            | user      | anonymous | random_response |
      | feedback | student01 response | student01 | 0         | 0               |
      | feedback | student02 response | student02 | 0         | 0               |
      | feedback | student03 response | student03 | 0         | 0               |
      | feedback | student04 response | student04 | 0         | 0               |
      | feedback | student05 response | student05 | 0         | 0               |
      | feedback | student06 response | student06 | 0         | 0               |
      | feedback | student07 response | student07 | 0         | 0               |
      | feedback | student08 response | student08 | 0         | 0               |
      | feedback | student09 response | student09 | 0         | 0               |
      | feedback | student10 response | student10 | 0         | 0               |
      | feedback | student11 response | student11 | 0         | 0               |
      | feedback | student12 response | student12 | 0         | 0               |
      | feedback | student13 response | student13 | 0         | 0               |
      | feedback | student14 response | student14 | 0         | 0               |
      | feedback | student15 response | student15 | 0         | 0               |
      | feedback | student16 response | student16 | 0         | 0               |
      | feedback | student17 response | student17 | 0         | 0               |
      | feedback | student18 response | student18 | 0         | 0               |
      | feedback | student19 response | student19 | 0         | 0               |
      | feedback | student20 response | student20 | 0         | 0               |
      | feedback | student21 response | student21 | 0         | 0               |
      | feedback | student22 response | student22 | 1         | 22              |
      | feedback | student23 response | student23 | 1         | 23              |
      | feedback | student24 response | student24 | 1         | 24              |
      | feedback | student25 response | student25 | 1         | 25              |
      | feedback | student26 response | student26 | 1         | 26              |
      | feedback | student27 response | student27 | 1         | 27              |
      | feedback | student28 response | student28 | 1         | 28              |
      | feedback | student29 response | student29 | 1         | 29              |
      | feedback | student30 response | student30 | 1         | 30              |
      | feedback | student31 response | student31 | 1         | 31              |
      | feedback | student32 response | student32 | 1         | 32              |
      | feedback | student33 response | student33 | 1         | 33              |
      | feedback | student34 response | student34 | 1         | 34              |
      | feedback | student35 response | student35 | 1         | 35              |
      | feedback | student36 response | student36 | 1         | 36              |
      | feedback | student37 response | student37 | 1         | 37              |
      | feedback | student38 response | student38 | 1         | 38              |
      | feedback | student39 response | student39 | 1         | 39              |
      | feedback | student40 response | student40 | 1         | 40              |
      | feedback | student41 response | student41 | 1         | 41              |
      | feedback | student42 response | student42 | 1         | 42              |
      | feedback | student43 response | student43 | 1         | 43              |
      | feedback | student44 response | student44 | 1         | 44              |
      | feedback | student45 response | student45 | 1         | 45              |
      | feedback | student46 response | student46 | 1         | 46              |
      | feedback | student47 response | student47 | 1         | 47              |
      | feedback | student48 response | student48 | 1         | 48              |
      | feedback | student49 response | student49 | 1         | 49              |
      | feedback | student50 response | student50 | 1         | 50              |
      | feedback | student51 response | student51 | 1         | 51              |
      | feedback | student52 response | student52 | 1         | 52              |
      | feedback | student53 response | student53 | 1         | 53              |
      | feedback | student54 response | student54 | 1         | 54              |
      | feedback | student55 response | student55 | 1         | 55              |
      | feedback | student56 response | student56 | 1         | 56              |
      | feedback | student57 response | student57 | 1         | 57              |
      | feedback | student58 response | student58 | 1         | 58              |
      | feedback | student59 response | student59 | 1         | 59              |
      | feedback | student60 response | student60 | 1         | 60              |
      | feedback | student61 response | student61 | 1         | 61              |
      | feedback | student62 response | student62 | 1         | 62              |
      | feedback | student63 response | student63 | 1         | 63              |
      | feedback | student64 response | student64 | 1         | 64              |
      | feedback | student65 response | student65 | 1         | 65              |
      | feedback | student66 response | student66 | 1         | 66              |
      | feedback | student67 response | student67 | 1         | 67              |
      | feedback | student68 response | student68 | 1         | 68              |
      | feedback | student69 response | student69 | 1         | 69              |
      | feedback | student70 response | student70 | 1         | 70              |
      | feedback | student71 response | student71 | 1         | 71              |
      | feedback | student72 response | student72 | 1         | 72              |
      | feedback | student73 response | student73 | 1         | 73              |
      | feedback | student74 response | student74 | 1         | 74              |
      | feedback | student75 response | student75 | 1         | 75              |
