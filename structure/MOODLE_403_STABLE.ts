 ...
 */
export type CoreBadgesGetUserBadgeByHashWSParams = {
 ...
 */
export type CoreBadgesGetUserBadgeByHashWSResponse = {
    badge: {
        id?: number; // Badge id.
 ...
 */
export type CoreGroupGetGroupsForSelectorWSParams = {
    courseid: number; // Course Id.
};
 ...
 */
export type CoreMyViewPageWSParams = {
 ...
 */
export type CoreSearchGetResultsWSParams = {
 ...
 */
export type CoreSearchGetSearchAreasListWSParams = {
    cat?: string; // Category to filter areas.
};
 ...
 */
export type CoreSearchGetTopResultsWSParams = {
    query: string; // The search query.
    filters?: {
        title?: string; // Result title.
        areaids?: string[]; // Restrict results to these areas.
 ...
 */
export type CoreSearchViewResultsWSParams = {
    query: string; // The search query.
    filters?: {
        title?: string; // Result title.
        areaids?: string[]; // Restrict results to these areas.
 ...
 */
export type CoreXapiDeleteStatesWSParams = {
    component: string; // Component name.
    activityId: string; // XAPI activity ID IRI.
    agent: string; // The xAPI agent json.
    registration?: string; // The xAPI registration UUID.
 ...
 */
export type EnrolGuestValidatePasswordWSParams = {
    instanceid: number; // Instance id of guest enrolment plugin.
 ...
 */
export type ModChatViewSessionsWSParams = {
    cmid: number; // Course module id.
 ...
 */
export type ModChatViewSessionsWSResponse = {
    status: boolean; // Status: true if success.
    warnings?: CoreWSExternalWarning[];
};
